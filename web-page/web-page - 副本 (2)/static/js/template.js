...
;(function (a) {
    ...
    a(".rightbar .rightbar-link").on("click", function () {
        a(".rightbar").addClass("open")
    });
    a(".rightbar .close-sidebar").on("click", function () {
    ...
    a("#mini-calendar").datepicker({
        todayHighlight: true, beforeShowDay: function (e) {
